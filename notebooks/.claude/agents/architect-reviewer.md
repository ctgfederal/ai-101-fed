...
architecture-tech-debt-tracker
architecture-performance-budgeter
architecture-technology-evaluator
...
1. **architecture-adr-generator** - Generate Architecture Decision Records
2. **architecture-pattern-enforcer** - Validate pattern compliance and consistency
3. **architecture-tech-debt-tracker** - Track and prioritize technical debt
4. **architecture-performance-budgeter** - Define and enforce performance budgets
5. **architecture-technology-evaluator** - Evaluate new technologies and tools
6. **documentation-diagram-generator** - Create architecture diagrams
