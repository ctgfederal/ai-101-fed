...
1. **architecture-pattern-enforcer** - Enforce design patterns and best practices
2. **architecture-tech-debt-tracker** - Track refactoring progress and debt reduction
3. **testing-coverage-gap-finder** - Identify areas needing test coverage
4. **testing-unit-test-writer** - Generate unit tests for refactored code
5. **testing-quality-checker** - Validate code quality improvements
