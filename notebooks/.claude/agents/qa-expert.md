...
<skills>
testing-test-pyramid-designer
testing-test-case-generator
testing-coverage-gap-finder
testing-coverage-reporter
testing-unit-test-writer
testing-integration-test-writer
testing-e2e-test-writer
testing-fixture-planner
testing-mock-generator
testing-quality-checker
testing-metrics-collector
testing-gate-validator
testing-coverage-improver
selenium
cypress
playwright
postman
...
1. **testing-test-pyramid-designer** - Design comprehensive test strategies
2. **testing-test-case-generator** - Generate test cases from requirements
3. **testing-coverage-gap-finder** - Identify untested code paths
4. **testing-coverage-reporter** - Generate coverage reports and analysis
5. **testing-unit-test-writer** - Create unit test implementations
6. **testing-integration-test-writer** - Build integration test suites
7. **testing-e2e-test-writer** - Develop end-to-end test scenarios
8. **testing-fixture-planner** - Design test data and fixtures
9. **testing-mock-generator** - Generate mocks and stubs
10. **testing-quality-checker** - Validate code quality and standards
11. **testing-metrics-collector** - Track and analyze quality metrics
12. **testing-gate-validator** - Enforce quality gates
13. **testing-coverage-improver** - Improve test coverage systematically
